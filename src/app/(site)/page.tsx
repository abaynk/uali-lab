...
export default function Home() {
  ...
  useEffect(() => {
    const getHeadingText = async () => {
      const headingText: homePageContentType = await getHomePageContent();
      headingText && headingText.text && setHeadingText(headingText.text);
    };
    const getHeadingVideo = async () => {
      const headingVideo: HomePageVideoType = await getHomePageVideo();
      headingVideo && headingVideo.video && setVideoURL(headingVideo.video);
    };
...
`}
      ...
      <SectionOneHeading headingText={headingText} />
      <SecondSectionVideo videoURL={videoURL} />
